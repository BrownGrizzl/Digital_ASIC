...
create_constraint_mode -name CONSTRAINTS -sdc_files {../Source/Top/Synthesis/top.sdc}
...
create_op_cond -name PVT_typ_1_8V_25C -library_file {/Cadence/Libs/X_FAB/XKIT/xt018/diglibs/D_CELLS_HD/v4_0/liberty_LP5MOS/v4_0_0/PVT_1_80V_range/D_CELLS_HD_LP5MOS_typ_1_80V_25C.lib} -P {1} -V {1.8} -T {25}
