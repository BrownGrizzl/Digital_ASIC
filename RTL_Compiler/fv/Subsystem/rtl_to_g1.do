...
usage -auto -elapse
set log file fv/Subsystem/rtl_to_g1.log -replace
tclmode
...
read library -statetable -liberty -both  \
	/Cadence/Libs/X_FAB/XKIT/xt018/diglibs/D_CELLS_HD/v4_0/liberty_LP5MOS/v4_0_0/PVT_1_80V_range/D_CELLS_HD_LP5MOS_typ_1_80V_25C.lib
...
elaborate design -golden -root Subsystem -rootonly

tclmode
if {$ver < 13.10} {
vpx read design -verilog -revised -lastmod -noelab \
	-unzip fv/Subsystem/g1.v.gz
} else {
...
elaborate design -revised -root Subsystem
...
write hier_compare dofile fv/Subsystem/hier_rtl_to_g1.do \
...
run hier_compare fv/Subsystem/hier_rtl_to_g1.do -dynamic_hierarchy
